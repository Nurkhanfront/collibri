        ...
        <div class="col-xl-3 col-lg-3 col-md-12 order_2">
          <div class="action_content">
            <div class="tab_actions">
              <p :class="{tab_background_dark: current === 'data'}" @click="updateTab('data')">Данные</p>
              <p :class="{tab_background_dark: current === 'order'}" @click="updateTab('order')">Заказы</p>
            </div>
          </div>
        </div>
              ...
              <form>
                <div class="account_main_content">
                  ...
                  <div class="row my-4 align-items-center">
                    ...
                    <div class="col-xl-10">
                      <button class="btn btn_outline_dark mt-2">Изменить</button>
                    </div>
                  </div>
                </div>
                <div class="account_bottom_content">
                  <div class="margin_input phone">
                    <div class="row align-items-center">
                      <p class="col-xl-2 col-md-2 mb-0 font_600 m_title">Телефон:</p>
                      <the-mask class="col-xl-6 col-md-6"
                          :mask="['#(###) ###-####']"
                    ...
                    <div class="row my-3">
                      <div class="col-xl-6 col-md-6">
                        <vue-picker v-model="options">
                          <vue-picker-option value="Город">{{ options }}</vue-picker-option>
                        </vue-picker>
                      </div>
                      <div class="col-xl-6 col-md-6">
                        <vue-picker v-model="options">
                          <vue-picker-option value="Город">Город</vue-picker-option>
                        </vue-picker>
                      </div>
                    </div>
                    <div class="row my-4">
